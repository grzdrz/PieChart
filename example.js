...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _list_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list-item */ \"./src/plugin/list-item.js\");\n\r\n\r\nclass ChartList {\r\n  constructor(chart, container) {\r\n    this.chart = chart;\r\n    this.container = container;\r\n  }\r\n\r\n  initialize() {\r\n    const itemsContainer = Array.from(this.container.querySelectorAll('.pie-chart__list-item'));\r\n    this.items = itemsContainer.map((itemContainer, index) => {\r\n      return new _list_item__WEBPACK_IMPORTED_MODULE_0__[\"default\"](this.chart, itemContainer, this.chart.segments[index]);\r\n    });\r\n\r\n  };\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (ChartList);\r\n\n\n//# sourceURL=webpack:///./src/plugin/ChartList.js?");
